...
#}
#
# Now, when you’re in a git repo, typing acp "a commit message" will add all changed files,
# commit them with whatever commit message you specified,
# then push them to your remote
